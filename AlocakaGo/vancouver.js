 ...
 * Starting Date: 13/08/2023
 * Description : vancouver pogo Maps
 * Working Stable
 */
...
eEmitter.on('getData', async () => {
    try {
        ...
        n = Date.now();
        url = `https://vanpokemap.com/query2.php?mons=63,19&time=${n}&since=${o}`;
        ...
        try {
            ...
            console.log(data.pokemons.lat + "," + data.pokemons.lng + "  -->" + unwrap(data.pokemons.pokemon_id));
        }
